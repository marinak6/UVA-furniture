# Generated by Django 2.2.4 on 2019-10-30 23:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bid',
            name='bidder',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='models.Person'),
        ),
        migrations.AddField(
            model_name='bid',
            name='item_id',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='models.Furniture'),
        ),
        migrations.CreateModel(
            name='Authenticator',
            fields=[
                ...
                ('person_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='models.Person')),
            ],
        ),
    ]
